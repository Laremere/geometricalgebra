...
func (v V1) MulV1(w V1) (float64, V1) {
	r0 := 0*v.E0*v.E0 + 0*v.E1*v.E1 + 0*v.E2*v.E2 + 0*v.E3*v.E3
	r1 := V2{
...
func (v V1) MulV2(w V2) (V0, V2) {
	r0 := V1{
		E0: 0*v.E1*v.E01 + 0*v.E2*v.E02 + 0*v.E3*v.E03,
		E1: 0*v.E0*v.E01 + 0*v.E2*v.E12 + 0*v.E3*v.E13,
		E2: 0*v.E0*v.E02 + 0*v.E1*v.E12 + 0*v.E3*v.E23,
		E3: 0*v.E0*v.E03 + 0*v.E1*v.E13 + 0*v.E2*v.E23,
	}
	r1 := V3{
...
func (v V1) MulV3(w V3) (V1, V3) {
	r0 := V2{
		...
		E02: 0*v.E1*v.E012 + 0*v.E3*v.E023,
		E12: 0*v.E0*v.E012 + 0*v.E3*v.E123,
		E03: 0*v.E1*v.E013 + 0*v.E2*v.E023,
		E13: 0*v.E0*v.E013 + 0*v.E2*v.E123,
...
func (v V2) MulV1(w V1) (V0, V2) {
	r0 := V1{
		E0: 0*v.E01*v.E1 + 0*v.E02*v.E2 + 0*v.E03*v.E3,
		E1: 0*v.E01*v.E0 + 0*v.E12*v.E2 + 0*v.E13*v.E3,
		E2: 0*v.E02*v.E0 + 0*v.E12*v.E1 + 0*v.E23*v.E3,
		E3: 0*v.E03*v.E0 + 0*v.E13*v.E1 + 0*v.E23*v.E2,
	}
	r1 := V3{
...
func (v V2) MulV2(w V2) (float64, V1, V3) {
	r0 := 0*v.E01*v.E01 + 0*v.E02*v.E02 + 0*v.E12*v.E12 + 0*v.E03*v.E03 + 0*v.E13*v.E13 + 0*v.E23*v.E23
	r1 := V2{
		E01: 0*v.E02*v.E12 + 0*v.E12*v.E02 + 0*v.E03*v.E13 + 0*v.E13*v.E03,
		E02: 0*v.E01*v.E12 + 0*v.E12*v.E01 + 0*v.E03*v.E23 + 0*v.E23*v.E03,
		E12: 0*v.E01*v.E02 + 0*v.E02*v.E01 + 0*v.E13*v.E23 + 0*v.E23*v.E13,
		E03: 0*v.E01*v.E13 + 0*v.E02*v.E23 + 0*v.E13*v.E01 + 0*v.E23*v.E02,
		E13: 0*v.E01*v.E03 + 0*v.E12*v.E23 + 0*v.E03*v.E01 + 0*v.E23*v.E12,
...
func (v V3) MulV1(w V1) (V1, V3) {
	r0 := V2{
		...
		E02: 0*v.E012*v.E1 + 0*v.E023*v.E3,
		E12: 0*v.E012*v.E0 + 0*v.E123*v.E3,
		E03: 0*v.E013*v.E1 + 0*v.E023*v.E2,
		E13: 0*v.E013*v.E0 + 0*v.E123*v.E2,
