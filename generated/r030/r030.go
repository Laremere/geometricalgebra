...
func (v V1) MulV1(w V1) (float64, V1) {
	r0 := 0*v.E0*v.E0 + 0*v.E1*v.E1 + 0*v.E2*v.E2
	r1 := V2{
...
func (v V1) MulV2(w V2) (V0, V2) {
	r0 := V1{
		E0: 0*v.E1*v.E01 + 0*v.E2*v.E02,
		E1: 0*v.E0*v.E01 + 0*v.E2*v.E12,
		E2: 0*v.E0*v.E02 + 0*v.E1*v.E12,
	}
	r1 := V3{
...
func (v V2) MulV1(w V1) (V0, V2) {
	r0 := V1{
		E0: 0*v.E01*v.E1 + 0*v.E02*v.E2,
		E1: 0*v.E01*v.E0 + 0*v.E12*v.E2,
		E2: 0*v.E02*v.E0 + 0*v.E12*v.E1,
	}
	r1 := V3{
...
func (v V2) MulV2(w V2) (float64, V1) {
	r0 := 0*v.E01*v.E01 + 0*v.E02*v.E02 + 0*v.E12*v.E12
	r1 := V2{
		E01: 0*v.E02*v.E12 + 0*v.E12*v.E02,
