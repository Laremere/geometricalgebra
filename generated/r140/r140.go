...
func (v V1) MulV1(w V1) (float64, V1) {
	r0 := -1*v.E0*v.E0 + 0*v.E1*v.E1 + 0*v.E2*v.E2 + 0*v.E3*v.E3 + 0*v.E4*v.E4
	r1 := V2{
...
func (v V1) MulV2(w V2) (V0, V2) {
	r0 := V1{
		...
		E2: -1*v.E0*v.E02 + 0*v.E1*v.E12 + 0*v.E3*v.E23 + 0*v.E4*v.E24,
		E3: -1*v.E0*v.E03 + 0*v.E1*v.E13 + 0*v.E2*v.E23 + 0*v.E4*v.E34,
...
func (v V1) MulV3(w V3) (V1, V3) {
	r0 := V2{
		...
		E23: -1*v.E0*v.E023 + 0*v.E1*v.E123 + 0*v.E4*v.E234,
...
func (v V2) MulV1(w V1) (V0, V2) {
	r0 := V1{
		...
		E2: 1*v.E02*v.E0 + 0*v.E12*v.E1 + 0*v.E23*v.E3 + 0*v.E24*v.E4,
		E3: 1*v.E03*v.E0 + 0*v.E13*v.E1 + 0*v.E23*v.E2 + 0*v.E34*v.E4,
...
func (v V2) MulV2(w V2) (float64, V1, V3) {
	...
	r1 := V2{
		...
		E23: 1*v.E02*v.E03 + 0*v.E12*v.E13 + -1*v.E03*v.E02 + 0*v.E13*v.E12 + 0*v.E24*v.E34 + 0*v.E34*v.E24,
...
func (v V3) MulV1(w V1) (V1, V3) {
	r0 := V2{
		...
		E23: -1*v.E023*v.E0 + 0*v.E123*v.E1 + 0*v.E234*v.E4,
