...
func (v V1) MulV1(w V1) (float64, V1) {
	r0 := -1*v.E0*v.E0 + -1*v.E1*v.E1 + 0*v.E2*v.E2 + 0*v.E3*v.E3 + 1*v.E4*v.E4
	r1 := V2{
...
func (v V1) MulV2(w V2) (V0, V2) {
	r0 := V1{
		E0: 1*v.E1*v.E01 + 0*v.E2*v.E02 + 0*v.E3*v.E03 + -1*v.E4*v.E04,
...
func (v V2) MulV1(w V1) (V0, V2) {
	r0 := V1{
		E0: -1*v.E01*v.E1 + 0*v.E02*v.E2 + 0*v.E03*v.E3 + 1*v.E04*v.E4,
...
func (v V2) MulV2(w V2) (float64, V1, V3) {
	r0 := -1*v.E01*v.E01 + 0*v.E02*v.E02 + 0*v.E12*v.E12 + 0*v.E03*v.E03 + 0*v.E13*v.E13 + 0*v.E23*v.E23 + 1*v.E04*v.E04 + 1*v.E14*v.E14 + 0*v.E24*v.E24 + 0*v.E34*v.E34
	r1 := V2{
...
func (v V2) MulV3(w V3) (V0, V2, V4) {
	r0 := V1{
		E0: 0*v.E12*v.E012 + 0*v.E13*v.E013 + 0*v.E23*v.E023 + 1*v.E14*v.E014 + 0*v.E24*v.E024 + 0*v.E34*v.E034,
...
func (v V3) MulV2(w V2) (V0, V2, V4) {
	r0 := V1{
		E0: 0*v.E012*v.E12 + 0*v.E013*v.E13 + 0*v.E023*v.E23 + 1*v.E014*v.E14 + 0*v.E024*v.E24 + 0*v.E034*v.E34,
...
func (v V3) MulV3(w V3) (float64, V1, V3) {
	r0 := 0*v.E012*v.E012 + 0*v.E013*v.E013 + 0*v.E023*v.E023 + 0*v.E123*v.E123 + -1*v.E014*v.E014 + 0*v.E024*v.E024 + 0*v.E124*v.E124 + 0*v.E034*v.E034 + 0*v.E134*v.E134 + 0*v.E234*v.E234
	r1 := V2{
