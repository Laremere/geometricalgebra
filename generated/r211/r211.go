...
func (v V1) MulV1(w V1) (float64, V1) {
	r0 := -1*v.E0*v.E0 + -1*v.E1*v.E1 + 0*v.E2*v.E2 + 1*v.E3*v.E3
	r1 := V2{
...
func (v V1) MulV2(w V2) (V0, V2) {
	r0 := V1{
		E0: 1*v.E1*v.E01 + 0*v.E2*v.E02 + -1*v.E3*v.E03,
...
func (v V2) MulV1(w V1) (V0, V2) {
	r0 := V1{
		E0: -1*v.E01*v.E1 + 0*v.E02*v.E2 + 1*v.E03*v.E3,
...
func (v V2) MulV2(w V2) (float64, V1, V3) {
	r0 := -1*v.E01*v.E01 + 0*v.E02*v.E02 + 0*v.E12*v.E12 + 1*v.E03*v.E03 + 1*v.E13*v.E13 + 0*v.E23*v.E23
	r1 := V2{
...
func (v V2) MulV3(w V3) (V0, V2) {
	r0 := V1{
		E0: 0*v.E12*v.E012 + 1*v.E13*v.E013 + 0*v.E23*v.E023,
...
func (v V3) MulV2(w V2) (V0, V2) {
	r0 := V1{
		E0: 0*v.E012*v.E12 + 1*v.E013*v.E13 + 0*v.E023*v.E23,
...
func (v V3) MulV3(w V3) (float64, V1) {
	r0 := 0*v.E012*v.E012 + -1*v.E013*v.E013 + 0*v.E023*v.E023 + 0*v.E123*v.E123
	r1 := V2{
